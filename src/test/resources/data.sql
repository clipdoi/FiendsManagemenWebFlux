...
CREATE TABLE IF NOT EXISTS public.user_relationship(
	...
	CONSTRAINT friend_relationship_email_id_foreign FOREIGN KEY (email_id) REFERENCES public."user"(email_id),
	CONSTRAINT friend_relationship_friend_id_foreign FOREIGN KEY (friend_id) REFERENCES public."user"(email_id)
);
